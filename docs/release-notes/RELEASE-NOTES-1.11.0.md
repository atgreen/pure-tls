...
identified by the [CLSEC initiative](https://github.com/atgreen/CLSEC).

## Security Fixes

### CLSEC-2026-0112 — Missing TLS 1.3 downgrade sentinel check (HIGH)
...
### CLSEC-2026-0113 — Missing legacy_session_id_echo validation (MEDIUM)
...
### CLSEC-2026-0114 — Non-cryptographic PRNG for ticket_age_add (MEDIUM)
...
### CLSEC-2026-0115 — Secret key material not zeroized (MEDIUM)
